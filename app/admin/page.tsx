          ...
          <div className={styles.adminList}>
            {admins.map(a => (
              <div key={a.email} className={styles.adminItem}>
                ...
                <button onClick={() => handleRemoveAdmin(a.email)} className={styles.removeBtn} aria-label="Remove"><Trash2 size={16} /></button>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className={styles.adminList}>
            {testers.map(t => (
              <div key={t.email} className={styles.adminItem}>
                ...
                <button onClick={() => handleRemoveTester(t.email)} className={styles.removeBtn} aria-label="Remove"><Trash2 size={16} /></button>
              </div>
            ))}
          </div>
        </div>
